...
make(exports, 'checkCustomizedCodes', function (cardId, code, callback) {
  var url = 'https://api.weixin.qq.com/card/code/checkcode?access_token=' + this.token.accessToken;
  var data = {
    "card_id": cardId,
    "code": code
  };
...
make(exports, 'getDepositCodesCount', function (cardId, callback) {
  var url = 'https://api.weixin.qq.com/card/code/getdepositcount?access_token=' + this.token.accessToken;
  var data = {
    "card_id": cardId
  };
  this.request(url, postJSON(data), wrapper(callback));
...
make(exports, 'addConsumer', function (username, locationId, callback) {
  var url = 'https://api.weixin.qq.com/card/consumer/add?access_token=' + this.token.accessToken;
  var data = {
    "username": username,
